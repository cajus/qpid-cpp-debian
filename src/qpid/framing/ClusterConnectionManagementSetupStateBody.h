...
class QPID_COMMON_CLASS_EXTERN ClusterConnectionManagementSetupStateBody : public ModelMethod {
    uint64_t objectNum;
...
public:
    ...
    QPID_COMMON_EXTERN void setVendor(const std::string& _vendor);
    QPID_COMMON_EXTERN const std::string& getVendor() const;
    QPID_COMMON_EXTERN bool hasVendor() const;
    QPID_COMMON_EXTERN void clearVendorFlag();
    QPID_COMMON_EXTERN void setProduct(const std::string& _product);
    QPID_COMMON_EXTERN const std::string& getProduct() const;
    QPID_COMMON_EXTERN bool hasProduct() const;
    QPID_COMMON_EXTERN void clearProductFlag();
    QPID_COMMON_EXTERN void setInstance(const std::string& _instance);
    QPID_COMMON_EXTERN const std::string& getInstance() const;
