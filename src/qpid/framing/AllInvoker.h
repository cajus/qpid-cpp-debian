    ...
    public qpid::framing::Invoker
{
  ...
  public:
    ...
    QPID_COMMON_EXTERN void visit(const ClusterClockBody& body);
    ...
    QPID_COMMON_EXTERN void visit(const ClusterConnectionQueueFairshareStateBody& body);
...
class QPID_COMMON_CLASS_EXTERN AMQP_AllOperations::ClusterHandler::Invoker:
    public qpid::framing::Invoker
{
...
class QPID_COMMON_CLASS_EXTERN AMQP_AllOperations::ClusterConnectionHandler::Invoker:
    public qpid::framing::Invoker
{
