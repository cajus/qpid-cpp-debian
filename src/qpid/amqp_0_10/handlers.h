...
struct ControlHandler:
    ...
    public cluster-connection::DtxStart::Handler,
    public cluster-connection::DtxEnd::Handler,
    public cluster-connection::DtxAck::Handler,
    public cluster-connection::DtxBufferRef::Handler,
    public cluster-connection::DtxWorkRecord::Handler,
