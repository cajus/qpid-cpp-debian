...
static const size_t MAX060 = sizeof(cluster-connection::AddQueueListener) > MAX059 ? sizeof(cluster-connection::AddQueueListener) : MAX059;
static const size_t MAX061 = sizeof(cluster-connection::ManagementSetupState) > MAX060 ? sizeof(cluster-connection::ManagementSetupState) : MAX060;
static const size_t MAX062 = sizeof(cluster-connection::Config) > MAX061 ? sizeof(cluster-connection::Config) : MAX061;
static const size_t MAX063 = sizeof(cluster-connection::QueueFairshareState) > MAX062 ? sizeof(cluster-connection::QueueFairshareState) : MAX062;
static const size_t MAX064 = sizeof(cluster-connection::QueueObserverState) > MAX063 ? sizeof(cluster-connection::QueueObserverState) : MAX063;
static const size_t MAX065 = sizeof(cluster-connection::Clock) > MAX064 ? sizeof(cluster-connection::Clock) : MAX064;
static const size_t MAX066 = sizeof(cluster-connection::QueueDequeueSincePurgeState) > MAX065 ? sizeof(cluster-connection::QueueDequeueSincePurgeState) : MAX065;
static const int MAX=MAX066;
