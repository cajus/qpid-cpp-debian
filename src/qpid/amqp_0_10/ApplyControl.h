    ...
    public ApplyVisitorBase<ControlVisitor, F>
{
    ...
    virtual void visit(cluster::Clock& x) { this->invoke(x); }
    ...
    virtual void visit(cluster-connection::QueueFairshareState& x) { this->invoke(x); }
    ...
    public ApplyVisitorBase<ConstControlVisitor, F>
{
    ...
    virtual void visit(const cluster::Clock& x) { this->invoke(x); }
    ...
    virtual void visit(const cluster-connection::QueueFairshareState& x) { this->invoke(x); }
