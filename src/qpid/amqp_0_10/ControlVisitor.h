...
struct ControlVisitor
{
    ...
    virtual void visit(cluster::Clock&) = 0;
    ...
    virtual void visit(cluster-connection::QueueFairshareState&) = 0;
...
struct ConstControlVisitor
{
    ...
    virtual void visit(const cluster::Clock&) = 0;
    ...
    virtual void visit(const cluster-connection::QueueFairshareState&) = 0;
