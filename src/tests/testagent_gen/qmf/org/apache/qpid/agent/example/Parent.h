...
QPID_BROKER_CLASS_EXTERN class Parent : public ::qpid::management::ManagementObject
{
  private:
 ...
 private:
  ...
  public:
    ...
    // Method IDs
    QPID_BROKER_EXTERN static const uint32_t METHOD_CREATE_CHILD = 1;
