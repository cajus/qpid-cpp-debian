...
#ifndef _MANAGEMENT_ORG_APACHE_QPID_BROKER_MGMT_TEST_TESTOBJECT_
#define _MANAGEMENT_ORG_APACHE_QPID_BROKER_MGMT_TEST_TESTOBJECT_
...
QPID_BROKER_CLASS_EXTERN class TestObject : public ::qpid::management::ManagementObject
{
  private:
